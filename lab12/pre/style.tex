...
\titleformat{\subsubsection}{\bfseries}{}{0pt}{\subsectionnum{subsection}.\alph{subsubsection})\qquad\quad#1\label{\arabic{section}\alph{subsection}\arabic{subsubsection}}}
